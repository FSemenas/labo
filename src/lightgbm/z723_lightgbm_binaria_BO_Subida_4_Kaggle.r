...
hs <- makeParamSet( 
         makeNumericParam("learning_rate",    lower=    0, upper=    0.5),
         makeNumericParam("feature_fraction", lower=    0  , upper=    1.0), # puede ir de 0 a 1
         makeIntegerParam("min_data_in_leaf", lower=    0L   , upper=  10000L), # setting it to hundreds or thousands is enough for a large dataset
         makeIntegerParam("num_leaves",       lower=   0L   , upper=  1040L),
...
PARAM$trainingstrategy$semilla_azar   <- 412339  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 412339  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
