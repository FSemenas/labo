...
PARAM$trainingstrategy$undersampling  <-  1   # un undersampling de 0.1  toma solo el 10% de los CONTINUA
PARAM$trainingstrategy$semilla_azar   <- 66667  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 66697  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
