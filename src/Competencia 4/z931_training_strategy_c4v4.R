...
PARAM  <- list()
PARAM$experimento <- "TS404"

PARAM$exp_input  <- "FE404"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201909, 202103, 202104, 202105, 202106, 202107 )

PARAM$train$training     <- c( 201907, 201908, 201909, 202103, 202104, 202105)
