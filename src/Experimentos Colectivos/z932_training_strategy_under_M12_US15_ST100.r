...
PARAM  <- list()
PARAM$experimento <- "TS9320_M12_US15_ST100"

PARAM$exp_input  <- "FE9250"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c( 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105 )

PARAM$train$training     <- c( 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103 )
